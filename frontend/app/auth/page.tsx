      ...
      <main className="relative min-h-screen flex flex-col items-center justify-center px-6 py-12 z-10">
        ...
        <div className="w-full max-w-md rounded-3xl p-8 shadow-2xl relative overflow-hidden" style={{ background: "rgba(255,255,255,0.03)", backdropFilter: "blur(24px)", border: "1px solid rgba(255,255,255,0.1)" }}>
          ...
          <nav className="flex border-b border-outline-variant/20 mb-8">
            ...
            >
              LOG IN
              {mode === "login" && <span className="absolute bottom-0 left-0 w-full h-1 rounded-t-full shadow-[0_-4px_12px_rgba(123,47,255,0.6)]" style={{ background: "linear-gradient(90deg,#7B2FFF,#00D2FD)" }} />}
            </button>
            <button
            ...
            >
              SIGN UP
              {mode === "signup" && <span className="absolute bottom-0 left-0 w-full h-1 rounded-t-full shadow-[0_-4px_12px_rgba(123,47,255,0.6)]" style={{ background: "linear-gradient(90deg,#7B2FFF,#00D2FD)" }} />}
            </button>
          </nav>
          ...
          <form onSubmit={handleSubmit} className="space-y-6" noValidate>
            ...
            <button
              type="submit"
              disabled={loading}
              className="w-full py-4 text-white font-bold rounded-xl hover:-translate-y-1 active:scale-[0.98] transition-all duration-300 disabled:opacity-50 disabled:cursor-not-allowed"
              style={{ background: "linear-gradient(90deg,#7B2FFF,#00D2FD)", boxShadow: "0 8px 32px rgba(123,47,255,0.35)" }}
            >
              {loading ? (

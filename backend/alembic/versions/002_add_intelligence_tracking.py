...
def upgrade() -> None:
    ...
    # ── performance_sessions: state + context + metadata columns ─────────────
    _add_column_safe("performance_sessions", sa.Column("abandoned", sa.Boolean(), nullable=False, server_default="0"))
    _add_column_safe("performance_sessions", sa.Column("avg_time_per_question", sa.Float(), nullable=True))
    _add_column_safe("performance_sessions", sa.Column("rushed_count", sa.Integer(), nullable=False, server_default="0"))
